...
export default function FailuresPage() {
  ...
  useEffect(() => {
    getFailures({ severity: severityFilter ?? undefined, status: statusFilter ?? undefined }).then((fetched) =>
      setResult({ key: filterKey, failures: fetched }),
    );
  }, [severityFilter, statusFilter, filterKey]);
