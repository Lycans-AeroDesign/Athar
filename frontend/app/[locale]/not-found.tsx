...
export default async function NotFound() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center gap-4 bg-background text-on-background px-6 text-center">
      ...
      <Link
        href="/"
        className="mt-2 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-on-primary font-label-caps text-label-caps uppercase hover:bg-primary-hover transition-colors"
      >
